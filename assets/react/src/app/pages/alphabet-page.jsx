...
const AlphabetPageNew = () => {
  ...
  */
  ...
  const isAlphabet = true;

  const isGraphemes = lastSegment === "graphemes";

  console.log("loading alphabet data...");
  const exerciceData = AlphabetData;
  console.log("alphabet data loaded:", exerciceData);
...
export default AlphabetPageNew;
