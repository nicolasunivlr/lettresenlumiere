...
const graphemeToSoundMap = {
  in: Sounds.Graphemes.IN,
  un: Sounds.Graphemes.IN,
  an: Sounds.Graphemes.AN,
  en: Sounds.Graphemes.AN,
  au: Sounds.Graphemes.AU,
  eau: Sounds.Graphemes.AU,
  eu: Sounds.Graphemes.EU,
  oeu: Sounds.Graphemes.EU,
  on: Sounds.Graphemes.ON,
  ou: Sounds.Graphemes.OU,
  oi: Sounds.Graphemes.OI,
  é: Sounds.Graphemes.E_AIGUE,
  è: Sounds.Graphemes.E_GRAVE,
  ien: Sounds.Graphemes.IEN,
  _ed: Sounds.Graphemes.E_AIGUE,
  _er: Sounds.Graphemes.E_AIGUE,
  _es: Sounds.Graphemes.E_AIGUE,
  _ez: Sounds.Graphemes.E_AIGUE,
  et: Sounds.Graphemes.E_GRAVE,
  est: Sounds.Graphemes.E_GRAVE,
  ai: Sounds.Graphemes.E_GRAVE,
  ei: Sounds.Graphemes.E_GRAVE,
};
