 ...
 */
final class Version20250219104058 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contenu_exercice (contenu_id INT NOT NULL, exercice_id INT NOT NULL, INDEX IDX_596D469C89D40298 (exercice_id), INDEX IDX_596D469C3C1CC488 (contenu_id), PRIMARY KEY(contenu_id, exercice_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
